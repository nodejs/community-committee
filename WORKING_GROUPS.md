# Node.js Community Working Groups

Node.js Community Working Groups are autonomous projects created by the
[Community Committee (CommComm)][./GOVERNANCE.md].

Working Groups can be formed at any time but must be ratified by the CommComm.
Once formed the work defined in the Working Group charter is the
responsibility of the WG rather than the CommComm.
...
Group's members or by a CommComm vote. Once revoked, any future work that arises
becomes the responsibility of the CommComm.

## Joining a WG

To find out how to join a working group, consult the (GOVERNANCE.md)[./GOVERNANCE.md] in
the working group's repository.

## Starting A Community Working Group

A Working Group is established by first defining a charter that can be
ratified by the CommComm. A charter is a *statement of purpose*, a
...
responsibilities are no longer governed by the CommComm and therefore should
not be broad or subjective. The only recourse the CommComm has over the working
...
Once the CommComm ratifies a charter the WG inherits the following
...
The WG meets every 2 weeks. A designated moderator approved by the
WG runs the meeting. Each meeting should be recorded and published
to YouTube. Most WGs choose to live stream directly to YouTube.
